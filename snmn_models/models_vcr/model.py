    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            lstm_seq, lstm_encodings, embed_seq = input_unit.build_input_unit(
                question_seq_batch, all_answers_seq_batch, all_rationales_seq_batch, question_length_batch, all_answers_length_batch, all_rationales_length_batch, bert_question_embeddings_batch, bert_answer_embeddings_batch, bert_rationale_embeddings_batch, num_vocab, self.seq_in_count, is_training=is_training, reuse=reuse, use_cudnn_lstm=use_cudnn_lstm, use_shared_lstm=use_shared_lstm)
