...
\begin{table}[]
    \begin{tabular}{@{}llcccccc@{}}
        ...
        \bottomrule
    \end{tabular}
    \captionsource(Dataset statistics){Breakdown of which visual tasks each dataset targets including the statistics of each dataset.\label{tab:dataset_stats}}{Written for this dissertation}
\end{table}

\todo[inline]{Relocate table to discussion section of literature review.}