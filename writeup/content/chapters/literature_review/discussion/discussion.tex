...
\begin{tabularx}{\linewidth}{cXcXc}
    ...
    SNMN & Seq2Seq RNN (See Chapter ~\ref{subsec:stack_neural_module_network}). & ND & ﬁnd, transform, and, or, ﬁlter, scene, answer, compare, noOp & S  \\
...
All the models explored use a module inventory to construct their networks.
