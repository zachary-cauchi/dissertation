...
\todo[inline]{One thing that came to mind is the possibility of a QR\rightarrow{}A task type and if the ordering sentences would make a difference in prediction (a sort of introduction (Q), methodology (R) and conclusion (A) pattern). Should I also discuss this as future work? I didn't find mention of it in the VCR paper.}
